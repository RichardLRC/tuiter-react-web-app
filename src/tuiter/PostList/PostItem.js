            ...
            <div className="col-11">
                ...
                <div className = {`${bookmark.link ==='' && bookmark.title === '' && bookmark.content === '' ? 'none' :'wd-padded-left'} ` }>
                    <div className={`${bookmark.link ==='' && bookmark.title === '' && bookmark.content === '' ? 'none' :'wd-border-content'}`}>
                        <div className = {`${bookmark.link ==='' && bookmark.title === '' && bookmark.content === '' ? 'none' : 'wd-title-padding'}`} style = {{"color": "white"}}>
                        <b>
                            {bookmark.title}
                        </b>
                        </div>
                        <div className = {`${bookmark.link ==='' && bookmark.title === '' && bookmark.content === '' ? 'none' :'wd-padding-around wd-fg-color'}`}>
                            {bookmark.content}
                            <br/>
                            <a href = {bookmark.link}><i className = {`${bookmark.linkAbbr ==='' ? 'none' :'fa fa-link wd-front-color'}`}>{bookmark.linkAbbr}</i></a>
                        </div>
...
//                     <span className ="wd-handle-name"> @{bookmark.handle} - {bookmark.time}</span>
//                 </div>
...
//                 </div>
//
//                 <div className = "wd-flex wd-left-padding">
//
//                     <img className = {`${bookmark.link ==='' && bookmark.title === '' && bookmark.content === '' ? 'wd-content-image1' :'wd-content-image'}`}
//                          src = {bookmark.img} height = "300px" width = "700px" alt=""/>
//
//                 </div>
//                 <div className = {`${bookmark.link ==='' && bookmark.title === '' && bookmark.content === '' ? 'none' :'wd-left-padding'}`}>
//                     <div className= {`${bookmark.link ==='' && bookmark.title === '' && bookmark.content === '' ? 'none' :'wd-border-content'}`}>
//                         <div className = {`${bookmark.link ==='' && bookmark.title === '' && bookmark.content === '' ? 'none' : 'wd-title-padding'}`} style = {{"color": "white"}}>
//                             <b>
//                                 {bookmark.title}
//                             </b>
//                         </div>
//                         <div className = {`${bookmark.link ==='' && bookmark.title === '' && bookmark.content === '' ? 'none' :'wd-around wd-front-color'}`}>
//                             {bookmark.content}
//                             <br/>
//                             <a href = {bookmark.link}><i className = {`${bookmark.linkAbbr ==='' ? 'none' :'fa fa-link wd-front-color'}`}>{bookmark.linkAbbr}</i></a>
//                         </div>
