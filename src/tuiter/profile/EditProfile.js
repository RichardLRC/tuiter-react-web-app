...
const EditProfile = () =>{
    ...
    const saveClickHandler = () => {
        console.log('Dispatching editProfile action', newProfile);
        dispatch(editProfile({ profile: newProfile }));
    };
    ...
    return(
        <>
            <div className="row pt-2">
                <div className="col-1">
                    <Link to = "/tuiter/profile" onClick={cancelClickHandler}><i className="fas fa-times wd-icon-color"/></Link>
                </div>
                <div className="col-9">
                    <h5>Edit Profile</h5>
                </div>
                <div className="col-1">
                    <Link to = "/tuiter/profile" onClick={saveClickHandler}
